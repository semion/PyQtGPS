...
class Button1(QtGui.QPushButton):
...
class Form(QDialog,QWidget):
    def __init__(self, parent= None):
        ...
        self.lab = MyLabel()
        self.lab.setPixmap(QPixmap("exit.png"))
        #self.lab.mouseDoubleClickEvent()
        ...
        btnlayout.addWidget(self.lab,5,0)
        ...
        kartinka = Kartinka(self)
        mlayout = QGridLayout()
        mlayout.addWidget(kartinka,0,0)
...
class Kartinka(QtGui.QWidget):
    ...
    def paintEvent(self,event):
        ...
        image = QtGui.QImage()
        if not QtCore.QFile.exists("16.png"):
            print "not found"
        image.load("16.png")
