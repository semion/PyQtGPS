...
class Pygps(QtGui.QWidget):
    ...
    def __init__(self, parent = None):
        ...
        size =  self.geometry()
        self.settings_panel.move(size.width()-40 - 2, 2)
        ...
        self.speed_panel.move(size.width()/2 - 75, size.height() - 35 - 2)
        self.olddata = ""
        ...
        if self.online:
            ...
            try:
                self.fh.connect(("00:0A:3A:27:14:3C", 1)) #("00:0D:B5:31:58:58", 1))
    ...
    def readLog(self):
        ...
        try:                
            ...
            if gps.id == 3:
                ...
                self.renderArea.tilegrid.moveTo(gps.latitude, gps.longitude, False)
                self.updateLabelLatLon(gps.latitude, gps.longitude)                            
                self.speed_panel.setText(self.tr("<b>%.1f</b> <small>km/h</small>" % gps.kmph))
                self.renderArea.update()                          
        except Exception, ex:
            print ex
            print line
